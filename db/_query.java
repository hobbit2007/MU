...
public class _query
{
	...
	public ObservableList<type_pm> _select_data_typepm()
	{
		...
		try {
			...
			s_class._AlertDialog(e.getMessage()+", "+ " ошибка в строке № 189!");
	       } finally {
	           //close connection ,stmt and resultset here
	       	try { cn.con.close(); } catch(SQLException se) { /*can't do anything */ }
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!	
	...
	public ObservableList<String> _select_typepm_inst()
	{
		...
		try {
			...
			s_class._AlertDialog(e.getMessage()+", "+ " ошибка в строке № 849!");
	       } finally {
	           //close connection ,stmt and resultset here
	       	try { cn.con.close(); } catch(SQLException se) { /*can't do anything */ }
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!				
	...
	public void _insert_type_pm(String type, String name, String desc, String icon)
	{
		...
		try {
			...
			s_class._AlertDialog(e.getMessage()+", "+ " ошибка в строке № 2118!");
		}
    	finally {
            //close connection ,stmt and resultset here
        	try { cn.con.close(); } catch(SQLException se) { /*can't do anything */ }
...
//		        System.out.println("SELECT WORKED: "+total_rez);
				...
				s_class._AlertDialog(e.getMessage()+", "+ " ошибка в строке № 2377!");
	        } finally {
	            //close connection ,stmt and resultset here
	        	try { cn.con.close(); } catch(SQLException se) { /*can't do anything */ }
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////		
	...
	public void _update_rec_tpm(String name, String desc, String type, String icon, String id)
	{
		...
		try {
			...
			s_class._AlertDialog(e.getMessage()+", "+ " ошибка в строке № 3395!");
		}
    	finally {
            //close connection ,stmt and resultset here
        	try { cn.con.close(); } catch(SQLException se) { /*can't do anything */ }
...
//////////////////////////////////////////////////////////////////////ACTION PLAN/////////////////////////////////////////////////////////////////////////////////				
				...
				public void _update_rec_ap(String id, String PM_Num, String Type, String Description, LocalDate Due_Date, String Equipment, String Otv_For_Task, String Otv, String shop, String icon, String icon_at)
				{
					...
					try {
						...
						s_class._AlertDialog(e.getMessage()+", "+ " ошибка в строке № 3465!");
					}
			    	finally {
			            //close connection ,stmt and resultset here
			        	try { cn.con.close(); } catch(SQLException se) { /*can't do anything */ }
			...
			try {
		        ...
		        while (rs12.next()) {
		        	...
		        	if(rs12.getString(1) != null && rs12.getString(2) != null && rs12.getString(3) != null) {
		        		...
		        		hsm.Qty_S.set(rs12.getString(17));
		        		hsm.Qty_W.set(rs12.getString(18));
		        		hsm.Qty_P.set(rs12.getString(19));
		        		hsm.Qty_A.set(rs12.getString(20));
		        		hsm.Price.set(rs12.getString(21));
		        		hsm.Key_No_Backup_Yes.set(rs12.getString(22));
		        		hsm.Key_No_Backup_No.set(rs12.getString(23));
		        		hsm.Key_Yes_Backup_Yes.set(rs12.getString(24));
		        		hsm.Key_Yes_Backup_No.set(rs12.getString(25));
		        		hsm.Risk_Breakage.set(rs12.getString(26));
		        		hsm.Delivery_Time.set(rs12.getString(27));
		        		hsm.Replacement_Model.set(rs12.getString(28));
		        		hsm.Qty_Interchangeability.set(rs12.getString(29));
		        		hsm.Qty_Identify_SP.set(rs12.getString(30));
		        		hsm.Identity_SP.set(rs12.getString(31));
		        		hsm.Coefficient.set(rs12.getString(32));
		        		hsm.MIN.set(rs12.getString(33));
		        		hsm.BATCH.set(rs12.getString(34));
