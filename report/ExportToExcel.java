...
public class ExportToExcel extends JFrame {
	 ...
	 Main mn = new Main();
		...
		public void showReport(String str) throws JRException, ClassNotFoundException, SQLException {
			...
			location = "\\\\10.168.170.49\\MU\\Blank_Letter_xls.jrxml";
	        ...
	        File outDir = new File("\\\\10.168.170.49\\MU\\jasperoutput");
	        outDir.mkdirs();
	  
	        JRXlsExporter exporter = new JRXlsExporter();
	        exporter.setExporterInput(new SimpleExporterInput(print));
	        exporter.setExporterOutput(new SimpleOutputStreamExporterOutput("\\\\10.168.170.49\\MU\\jasperoutput\\Task_Report"+conn_connector.USER_ID+".xls"));
            
            exporter.exportReport();
        	try {
        		File excelFile = new File("\\\\10.168.170.49\\MU\\jasperoutput\\Task_Report"+conn_connector.USER_ID+".xls");
